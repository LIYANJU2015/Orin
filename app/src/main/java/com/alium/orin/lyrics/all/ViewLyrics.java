package com.alium.orin.lyrics.all;

import com.alium.orin.lyrics.Net;
import com.alium.orin.lyrics.Reflection;
...
public class ViewLyrics {
    ...
    public static Lyrics fromMetaData(String artist, String title) throws IOException, NoSuchAlgorithmException, SAXException, ParserConfigurationException {
        ...
        int artistDistance = distance(results.get(0).getArtist(), artist);
        int titleDistance = distance(results.get(0).getTrack(), title);
